package com.grandmen123.xtutorial.entity.client;
...
public class TigerModel extends GeoModel<TigerEntity> {
    ...
    public ResourceLocation getModelResource(TigerEntity animatable) {
        return new ResourceLocation(XTutorial.MOD_ID, "geo/tiger.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(TigerEntity animatable) {
        return new ResourceLocation(XTutorial.MOD_ID, "textures/entity/tiger.png");
    }

    @Override
    public ResourceLocation getAnimationResource(TigerEntity animatable) {
        return new ResourceLocation(XTutorial.MOD_ID, "animations/tiger.animation.json");
    }
