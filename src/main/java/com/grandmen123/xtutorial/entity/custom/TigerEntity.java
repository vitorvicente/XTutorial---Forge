package com.grandmen123.xtutorial.entity.custom;
...
public class TigerEntity extends Animal implements GeoEntity {
    ...
    public TigerEntity(EntityType<? extends Animal> entityType,
                       Level level) {
